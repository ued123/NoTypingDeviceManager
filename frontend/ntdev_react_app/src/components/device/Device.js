    ...
    return (
        <div className="row height-100">
          ...
          <div className="col-xs-4 col-sm-4 col-md-4 col-lg-4 height-100">
            ...
            {/* 리스트결과 영역 */}
            <DevicePrimaryCompList devicePartContainer={devicePartContainer} isSearchList = {isSearchList} doSearchInitialize = {this.doSearchInitialize} doSearchOne = {this.doSearchOne} />
          </div>
          {/* 장비 상세정보 창 영역
              col-xs viewport width 300
              col-sm viewport width 800
          ...
          <div className="col-xs-8 col-sm-8 col-md-8 col-lg-8 device-bg-1 deviceDetailWrapper">
            <div className="row ml-3 h-100">
              ...
              <ul className="list-group w-100">
                <DeviceDetailComp isSearchOne = {isSearchOne} doSearchInitialize = {this.doSearchInitialize} devicePartContainer={devicePartContainer} />
              </ul>
